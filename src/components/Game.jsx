...
export default function Game() {
  useEffect(() => {
    ...
    //generate sides with random entry and exit points [COPY1]
    function genSides() {
    ...
    //gen maze using Recursive Backtracking [COPY3]
